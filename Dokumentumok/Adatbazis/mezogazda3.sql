...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2025. Nov 20. 19:41
...
CREATE TABLE `fold` (
  ...
  `muvelesi_ag` varchar(100) COLLATE utf8mb4_hungarian_ci DEFAULT NULL,
  `helyrajzi_szam` varchar(50) COLLATE utf8mb4_hungarian_ci DEFAULT NULL,
  `elozo_evi_hasznositas` varchar(255) COLLATE utf8mb4_hungarian_ci DEFAULT NULL,
...
CREATE TABLE `input_anyag` (
  `id` int(11) NOT NULL,
  `inev` varchar(100) COLLATE utf8mb4_hungarian_ci NOT NULL,
  `ar` decimal(10,2) NOT NULL,
  `fajta` varchar(255) COLLATE utf8mb4_hungarian_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_hungarian_ci;
...
CREATE TABLE `noveny` (
  `id` int(11) NOT NULL,
  `nnev` varchar(100) COLLATE utf8mb4_hungarian_ci NOT NULL,
