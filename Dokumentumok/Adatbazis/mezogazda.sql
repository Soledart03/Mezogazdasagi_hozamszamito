...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2025. Okt 12. 21:31
...
CREATE TABLE `terv` (
  ...
  `szemett` decimal(10,2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_hungarian_ci;
...
INSERT INTO `terv` (`id`, `fold_id`, `noveny_id`, `vetes_idopont`, `viz`, `tomeg`, `osszeg`, `szemett`) VALUES
(1, 1, 1, '2025-03-20', 750.00, 5200.00, 780000.00, 100.00),
(2, 2, 2, '2025-04-10', 820.00, 6400.00, 910000.00, 120.00),
(3, 3, 3, '2025-03-25', 600.00, 4800.00, 860000.00, 80.00);
