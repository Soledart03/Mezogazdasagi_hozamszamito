...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2026. Feb 09. 09:22
...
(16, 12, 7, 19, 40, '2026-02-19', 10.00, 121100.00),
(19, 10, 5, 18, 40, '2026-04-01', 15.00, 448800.00);

--
-- Eseményindítók `terv`
--
DELIMITER $$
CREATE TRIGGER `trg_osszeg_write_once` BEFORE UPDATE ON `terv` FOR EACH ROW BEGIN
  
    IF OLD.osszeg <> 0
       AND NEW.osszeg <> OLD.osszeg THEN
        SIGNAL SQLSTATE '45000'
            SET MESSAGE_TEXT = 'Az osszeg már nem 0, ezért nem módosítható';
    END IF;
END
$$
DELIMITER ;
